        ...
        // When lower Quantity is clicked
            ...
            addItem.forEach(item => {                
                if (item.FoodID === id && item.Quantity >= 1){
                    item.Quantity -= 1;
                    if (item.Quantity === 0){
                        if ( window.location != 'https://cheery-empanada-646a22.netlify.app/user-orders.html'){
        ...
        if (user) {
            ...
            .on('value', function(snapshot){
                if (snapshot.exists()){
                    ...
                    // Empty Array
                    addItem = []
                    for (let i = 0; i< userCart.length; i++){9
            ...
            checkOutBtn.addEventListener('click', ()=>{
                ...
                if (addItem.length != 0){
                    ...
                    window.setTimeout(function(){
                        window.location.replace('https://cheery-empanada-646a22.netlify.app/user-orders.html')
                    }, 2600)
                } else {
                    Swal.fire({
                        icon: 'error',
            ...
            // Shows Orders
            if (window.location.href === 'https://cheery-empanada-646a22.netlify.app/user-orders.html'){
